...
def equals():
    ...
    try:
        ...
        equation_label.set("Arimetic Error")
        equation_text = ""
def clear():
    global equation_text
    equation_label.set("")
...
label = Label(window,bg="white",height=2,width=30,font=("consolas",20),textvariable=equation_label)
label.pack()
frame = Frame(window)
frame.pack()
...
equals = Button(frame,text="=",height=4,width=9,command= equals)
...
clear = Button(window,text="Clear",height=4,width=12,font=30,command= clear)
clear.pack()
window.mainloop()